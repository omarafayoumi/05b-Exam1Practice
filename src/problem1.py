...
def run_test_problem1b():
    ...
    # Test 2:
    expected = 2971  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([30, 100], expected, test_results,
                                  format_string)
    actual = problem1b(30, 100)
    print_actual_result_of_test(expected, actual, test_results, precision=3)

    # Test 3:
    expected = 31  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([5, 7], expected, test_results,
                                  format_string)
    actual = problem1b(5, 7)
    print_actual_result_of_test(expected, actual, test_results, precision=3)

    # Test 4:
    expected = 67  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([6, 12], expected, test_results,
                                  format_string)
    actual = problem1b(6, 12)
    print_actual_result_of_test(expected, actual, test_results, precision=3)
